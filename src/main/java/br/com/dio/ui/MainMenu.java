...
public class MainMenu {
    ...
    public void execute() throws SQLException {
        ...
        while (true){
            ...
            System.out.println("3 - Exculir um board");
    ...
    private void createBoard() throws SQLException {
        ...
        System.out.println("Seu board terá colunas além das 3 padrões? se sim informe quantas, senao digite '0'");
        ...
        for(var i = 0; i < additionalColumns; i++){
            System.out.println("Informe o nome da coluna de tarefa pendete");
