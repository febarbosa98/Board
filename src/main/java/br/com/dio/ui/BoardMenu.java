...
public class BoardMenu {
    ...
    private void createCad() throws SQLException {
    ...
    private void blockCard() throws SQLException  {
        System.out.println("informe o o id do card que sera bloqueado");
        var cardId = scanner.nextLong();
    ...
    private void unblockCard() throws SQLException {
        System.out.println("informe o o id do card que sera desbloqueado");
        var cardId = scanner.nextLong();
    ...
    private void showBoard() throws SQLException {
        try (var connection = getConnection()){
            ...
            optional.ifPresent(b -> {
                ...
                b.columns().forEach(c -> {
                    System.out.printf("coluna [%s] tio [%s] tem %s cards\n", c.name(), c.kind(), c.cardsAmount());
                });
            });
        ...
        try (var connection = getConnection()){
            new CardQueryService(connection).findById(selectedCardId)
                    .ifPresentOrElse(c -> {
                        ...
                        System.out.println(c.blocked() ? "Esta bloqueado. Motivo " + c.blockReason()  : "Não esta bloqueado");
                        System.out.printf("Ja foi bloqueado %s vezes\n", c.blocksAmount());
                        System.out.printf("Esta no momento na coluna %s - %s\n", c.columnId(), c.columnName());
                    }, () ->System.out.printf("Não exite um card com o id %s\n", selectedCardId));
